# Generated by Powerlevel10k configuration wizard on 2025-09-14 at 14:17 CEST.
...
() {
  ...
  function prompt_envtype() {
  if [[ "$HOST" == "pve-dev" ]]; then
    p10k segment -f 2 -t '[PVE]'
  else
    p10k segment -f 4 -t '[CT]'
  fi
  }
